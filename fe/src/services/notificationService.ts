...
export interface NotificationDto {
  ...
  title: string;
  content: string;
  type: "MATCH_JOINED" | "MATCH_LEFT" | "MATCH_CANCELLED" | "MATCH_RESUMED" | "SYSTEM" | "NEW_MESSAGE" | "BILL_CREATED" | "BILL_PAID" | "BILL_CONFIRMED" | "MATCH_REVIEW_REQUEST" | "FRIEND_REQUEST" | "FRIEND_ACCEPTED" | "ACCOUNT_BANNED";
